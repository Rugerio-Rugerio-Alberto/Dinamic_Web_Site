...
<body>
    ...
    <div class="cont">
        <div class="item">
            ...
            <button class="btn btn-primary"><a href="Administrar.html">Regresar</a></button>
    ...
    if(isset($_POST['buscar'])) {
        ...
        echo "<font color='#6F6F6F'>
            <tr>
                <td><b>Código&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspCategoria&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspProducto&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspMarca&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspPrecio&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspExistencia</b></td>
            </tr> 
        </font>";
        ...
        while($co=mysqli_fetch_array($c)){
            ...
            echo "<font color='#6F6F6F'>
                ...
                <tr>
                    <td><b><center>________________________________________________________________________________________________</center></b></td>
                </tr>
                <tr>
                    <td>".$co['Id_Producto']."<td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp»&nbsp;&nbsp;&nbsp;&nbsp;&nbsp
